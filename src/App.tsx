  ...
  return (
    <div className="bg-[#1e2121] border-2 border-[#a6adae]/50 rounded-[15px] p-6 w-72 lg:w-80 shadow-2xl text-left">
      ...
      <div className="border-t border-white/10 pt-3 pb-1">
        <a
          href={EMAIL_URL}
          className="flex items-center gap-2 text-white/80 hover:text-white text-xs font-medium transition-colors group truncate"
          title="Enviar e-mail"
        >
          <Mail size={14} className="text-[#5b68f5] shrink-0 group-hover:scale-110 transition-transform" />
